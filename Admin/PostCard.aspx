...
function printfunction(content) {
    ...
    $('#Onlyforprintframe').css('display', 'block');
    var frame = $('#Onlyforprintframe')[0].contentWindow.document;
    frame.open();
    frame.write(content);
    frame.close();
    // print just the modal div
    $('#Onlyforprintframe')[0].contentWindow.print();
    $('#Onlyforprintframe').css('display', 'none');
}//print function code
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="mypopup">
        <div style="margin-top: 30px; height: 44px; background: #026F52; width: 982px;">
            <button type="button" class="close close_popup_Postcard" id="close_popup " data-dismiss="modal">&times;</button>
        </div>
        <iframe id="printframe"></iframe>

    </div>
    <iframe id="Onlyforprintframe" style="display: none;"></iframe>
